	...
	return (
		<div className="mx-4 flex flex-col gap-4 lg:flex-row lg:justify-center break-words">
			...
			<div className="flex flex-row flex-wrap h-max gap-3 lg:flex-col lg:sticky lg:top-3 lg:w-[23rem]">
				<DetailCard color="amber" title="Basic information:" content={filterDetails(details)} />
				<DetailCard color="rose" title="Nutritional values:" content={filterNutrions(nutrions)} />
				<DetailCard color="blue" title="Ingredients:" list={ingredients} />
				<Steps content={steps} />
			</div>
		</div>
	)
